...
(function(win) {
		...
		render: function() {
			return (
				React.createElement("div", null, 
					React.createElement(Header, {message: this.props.message})
				)
			);
		}
	});
	...
	function render() {
		React.render(React.createElement(App, {message: "Hello World"}), document.getElementById('app'));
	}
...
},{"./components/common/header":158,"jquery":2,"react":157}]},{},[159]);
